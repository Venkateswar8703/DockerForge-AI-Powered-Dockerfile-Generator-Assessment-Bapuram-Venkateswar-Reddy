    ...
    if attempt == 1 and behavior == "fail-and-fix":
        if project_type == "node":
            ...
            err_log = (
                ...
                "npm ERR! \n"
                "npm ERR! While resolving: express-app@1.0.0\n"
                "npm ERR! Found: ejs@3.1.10\n"
                "npm ERR!   ejs@\"^3.1.10\" from the root project\n"
                "npm ERR! \n"
                "npm ERR! Could not resolve dependency:\n"
                "npm ERR! peer ejs@\"^3.1.6\" from express-ejs-layouts@2.5.1\n"
                "npm ERR!   express-ejs-layouts@\"^2.5.1\" from the root project\n"
                "npm ERR! \n"
                "npm ERR! Conflicting peer dependency: ejs@3.1.6\n"
                "npm ERR! node_modules/ejs\n"
                "npm ERR! \n"
